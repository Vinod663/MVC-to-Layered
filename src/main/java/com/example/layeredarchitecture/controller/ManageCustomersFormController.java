...
//            Connection connection = DBConnection.getDbConnection().getConnection();//less boilerplate code
...
//            }
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {//customer save button action
